...
const OP_CODE_NAME_INPUT = "INPUT"
...
const OP_CODE_BYTE_INPUT = byte(13)
const OP_CODE_BYTE_OUTPUT = byte(14)
const OP_CODE_BYTE_BRANCH_POSITIVE = byte(15)
const OP_CODE_BYTE_BRANCH_NOT_POSITIVE = byte(16)
const OP_CODE_BYTE_BRANCH_ZERO = byte(17)
const OP_CODE_BYTE_BRANCH_NOT_ZERO = byte(18)
const OP_CODE_BYTE_BRANCH_NEGATIVE = byte(19)
const OP_CODE_BYTE_BRANCH_NOT_NEGATIVE = byte(20)
const OP_CODE_BYTE_GOTO = byte(21)
const OP_CODE_BYTE_STOP = byte(22)
